          ...
          {!isMobile && (
            ...
            >
              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect opacity="0.01" x="4" y="4" width="22" height="22" fill="currentColor" />
                <rect opacity="0.01" x="3" y="3" width="24" height="24" fill="currentColor" />
                <rect x="5" y="8" width="20" height="2" rx="1" fill="currentColor" />
                <rect x="5" y="14" width="20" height="2" rx="1" fill="currentColor" />
                <rect x="5" y="20" width="20" height="2" rx="1" fill="currentColor" />
              </svg>
            </button>
          )}
          <h1>
